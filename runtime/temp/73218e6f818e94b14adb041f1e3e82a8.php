<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/www/wwwroot/yanyanyang/www.lingdayun.com/public/../application/admin/view/teach/ziliao.html";i:1682257462;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
            ...
            <div class="card">
              <div class="card-toolbar clearfix">
                ...
                <div class="toolbar-btn-action">
                  <a class="btn btn-primary m-r-5" href="/index.php/admin/Teach/ziliao_add"><i class="mdi mdi-plus"></i> 新增</a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <?php echo $data['id']; ?></td>
						 <td> <?php echo $data['ziliao_name']; ?></td>
						
                        <td> <?php echo $data['nianji_cate']; ?></td>
						 <td> <?php echo $data['kemu_cate']; ?></td>
						
                       <!-- <td> <iframe src='https://view.officeapps.live.com/op/view.aspx?src=http://storage.xuetangx.com/public_assets/xuetangx/PDF/<?php echo $data['ziliao_src']; ?>' width='100%' height='100%' frameborder='1'>查看</iframe>
</td> -->
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-xs btn-default" href="#!" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                           
                            <a class="btn btn-xs btn-default" href="/index.php/admin/Teach/ziliao_del?id=<?php echo $data['id']; ?>" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                          </div>
                        </td>
                      </tr>
