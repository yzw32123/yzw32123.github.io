<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/www/wwwroot/yanyanyang/www.lingdayun.com/public/../application/admin/view/lunbo/index.html";i:1673318231;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
            ...
            <div class="card">
              <div class="card-toolbar clearfix">
                ...
                <div class="toolbar-btn-action">
                  <a class="btn btn-primary m-r-5" href="/index.php/admin/Lunbo/add"><i class="mdi mdi-plus"></i> 新增</a>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-xs btn-default" href="/index.php/admin/Lunbo/edit/id/<?php echo $data['id']; ?>" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                            <a class="btn btn-xs btn-default" href="#!" title="查看" data-toggle="tooltip"><i class="mdi mdi-eye"></i></a>
                            <a class="btn btn-xs btn-default" href="/index.php/admin/Lunbo/del" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                          </div>
                        </td>
                      </tr>
