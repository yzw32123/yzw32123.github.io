<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\wwwroot\www.lingdayun.com\public/../application/admin\view\teach\teacher_add.html";i:1671254617;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
                 ...
                 <!-- <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-12">
					...
					<div class="form-group col-md-12">
					  ...
					  <input type="radio" class="form-control" id="is_mingshi" name="is_mingshi" value="1"  />是
					   <input type="radio" class="form-control" id="is_mingshi" name="is_mingshi"  value="0" />否
					</div>
                  <div class="form-group col-md-12">
