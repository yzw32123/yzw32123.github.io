<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"/www/wwwroot/yanyanyang/www.lingdayun.com/public/../application/admin/view/teach/answer_add.html";i:1673318231;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <form action="/index.php/admin/teach/answer_add_post" method="post" class="row">
                 <!-- <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="wenti" name="wenti" value="" placeholder="请输入科目" />
                  </div>
					 <div class="form-group col-md-12">
					   <label for="title">答案</label>
						<textarea name="answer" class="form-control"  placeholder="请输入答案" style="width: 50%;height: 300px;"></textarea>
					 </div>
                  <div class="form-group col-md-12">
