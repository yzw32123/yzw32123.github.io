<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\wwwroot\www.lingdayun.com\public/../application/admin\view\teach\answer_edit.html";i:1671795181;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <form action="/index.php/admin/teach/answer_edit_post" method="post" class="row">
                 <!-- <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="wenti" name="wenti" value="<?php echo $list['wenti']; ?>" placeholder="请输入科目" />
                  </div>
					<div class="form-group col-md-12">
					  <label for="title">答案</label>
											<textarea name="answer"  placeholder="请输入答案"><?php echo $list['answer']; ?></textarea>
					</div>
                  <div class="form-group col-md-12">
