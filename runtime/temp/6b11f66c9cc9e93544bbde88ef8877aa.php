<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/www/wwwroot/yanyanyang/www.lingdayun.com/public/../application/admin/view/teach/answer.html";i:1673318231;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
            ...
            <div class="card">
              <div class="card-toolbar clearfix">
                ...
                <div class="toolbar-btn-action">
                  <a class="btn btn-primary m-r-5" href="/index.php/admin/Teach/answer_add"><i class="mdi mdi-plus"></i> 新增</a>
                  ...
                  <table class="table table-bordered  table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <?php echo $data['wenti']; ?></td>
                        
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-xs btn-default" href="/index.php/admin/Teach/answer_edit?id=<?php echo $data['id']; ?>" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                         
                            <a class="btn btn-xs btn-default" href="/index.php/admin/Teach/answer_del?id=<?php echo $data['id']; ?>" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                          </div>
                        </td>
                      </tr>
