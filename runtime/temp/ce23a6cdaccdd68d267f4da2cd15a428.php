<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"/www/wwwroot/yanyanyang/www.lingdayun.com/public/../application/admin/view/teach/teacher_list.html";i:1673318231;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
            ...
            <div class="card">
              <div class="card-toolbar clearfix">
                ...
                <div class="toolbar-btn-action">
                  <a class="btn btn-primary m-r-5" href="/index.php/admin/Teach/teacher_add"><i class="mdi mdi-plus"></i> 新增</a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <?php echo $data['school']; ?></td>
						 <td> <?php if($data['is_mingshi'] == 0): ?>否<?php else: ?>是<?php endif; ?></td>
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-xs btn-default" href="/index.php/admin/Teach/teacher_edit?id=<?php echo $data['id']; ?>" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                            <a class="btn btn-xs btn-default" href="/index.php/admin/Teach/teacher_del?id=<?php echo $data['id']; ?>" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                          </div>
                        </td>
                      </tr>
