<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"/www/wwwroot/yanyanyang/www.lingdayun.com/public/../application/admin/view/teach/kemu.html";i:1673318231;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
                  ...
                  <table class="table table-bordered  table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-xs btn-default" href="/index.php/admin/Teach/kemu_edit?id=<?php echo $data['id']; ?>" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
