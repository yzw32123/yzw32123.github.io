<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"/www/wwwroot/yanyanyang/www.lingdayun.com/public/../application/admin/view/teach/kemu_add.html";i:1673318231;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <form action="/index.php/admin/teach/kemu_add_post" method="post" class="row">
                 <!-- <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="kemu_cate" name="kemu_cate" value="" placeholder="请输入科目" />
                  </div>
