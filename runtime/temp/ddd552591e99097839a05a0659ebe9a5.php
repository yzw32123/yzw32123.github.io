<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/www/wwwroot/yanyanyang/www.lingdayun.com/public/../application/admin/view/index/index.html";i:1673318230;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
  ...
  <div class="lyear-layout-container">
    ...
    <!-- <main class="lyear-layout-content">
      ...
      <div class="container-fluid main_right" > -->
		   <iframe frameborder="0" scrolling="yes" style="width:100%;" src="/index.php/admin/Index/mains" id="aa"></iframe>
        <!-- 
        -->
